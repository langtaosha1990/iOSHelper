#
# Be sure to run `pod lib lint iOSHelper.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/langtaosha1990/iOSHelper'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Gpf' => '13301@163.com' }
  s.source           = { :git => 'https://github.com/langtaosha1990/iOSHelper.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '10.0'

  s.source_files = 'iOSHelper/GUnitySupport/**/*'
